...
const page = ({params}) => {
  ...
  return (data?<>
    ...
    <div className='mx-5 max-w-[800px] md:mx-auto mt-[-100px] mb-10'>
        ...
        <p className='my-3'>Before you can manage your lifestyle, you must have a clear understanding of waht you want to achieve. Start by reflecting on your values, aspirations, and long term goals.</p>
        <p className='my-3'>Before you can manage your lifestyle, you must have a clear understanding of waht you want to achieve. Start by reflecting on your values, aspirations, and long term goals.</p>
